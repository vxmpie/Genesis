    ...
    <header className="sticky top-0 z-40 bg-genesis-bg/95 border-b border-white/[0.08] backdrop-blur-xl px-4 py-2.5 sm:px-6 sm:py-3 transition-all duration-200">
      <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-3 sm:gap-4">
        ...
        <div className="flex items-center gap-2.5 sm:gap-3.5">
          <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-lg bg-gradient-to-br from-genesis-accent to-orange-500 flex items-center justify-center text-white shadow-glow-accent ring-1 ring-white/20 animate-pulse-glow">
        ...
        <div className="order-2 sm:order-3 flex items-center gap-2 sm:gap-3 ml-auto sm:ml-0">
          ...
          <button
            ...
            className="hidden md:flex items-center gap-1 px-2.5 py-1 text-xs font-mono font-medium text-slate-300 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.1] rounded-md transition-all"
            title="Quick Command Palette (Ctrl+K)"
          >
            <Zap className="w-3.5 h-3.5 text-genesis-cyan" />
            <span>HUB</span>
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold transition-all border ${
                authenticated
                  ...
                  : 'bg-genesis-amber/10 text-genesis-amber border-genesis-amber/30 animate-pulse'
              }`}
            >
